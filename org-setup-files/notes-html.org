...
#+HTML_HEAD: html {
#+HTML_HEAD: 	font-size: 62.5%;
#+HTML_HEAD: }
#+HTML_HEAD: body {
#+HTML_HEAD: 	background-color: #282828;
#+HTML_HEAD: 	color: #fff;
#+HTML_HEAD: 	font-family: "Century Gothic", helvetica, arial, sans-serif;
#+HTML_HEAD: 	font-size: 1.4em; /* equiv 14px */
#+HTML_HEAD: 	line-height: 1.5; /* adapt to your design */
...
#+HTML_HEAD: 	margin:  1.1667em 0 0 0;
...
#+HTML_HEAD: 	margin:  1.3125em 0 0 0;
